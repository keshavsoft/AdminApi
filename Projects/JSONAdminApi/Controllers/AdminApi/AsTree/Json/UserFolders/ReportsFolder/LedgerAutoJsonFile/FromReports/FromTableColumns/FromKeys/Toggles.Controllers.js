let Repos = require("../../../../../../../../../../Repository/AdminApi/AsTree/Json/UserFolders/ReportsFolder/LedgerAutoJsonFile/FromReports/FromTableColumns/FromKeys/Toggles");
...
let PatchFuncs = async (req, res) => {
    ...
    let LocalFromRepo = await Repos.Update({
        ...
        inTableColumnsPk: jVarLocalvoucher,
